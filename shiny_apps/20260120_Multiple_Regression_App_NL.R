...
calc_multi2_manual_truth <- function(df, y_var, x_vars) {
  ...
  # Step 8: Calculate variances and SDs from 4-decimal sums of squares
  ...
  # Step 9: Calculate covariances from 4-decimal cross-products
  cov_x1y <- round(S1y / (n - 1), 4)
  cov_x2y <- round(S2y / (n - 1), 4)
  cov_x1x2 <- round(S12 / (n - 1), 4)
  
  # Step 10: Calculate correlations from 4-decimal covariances and SDs
