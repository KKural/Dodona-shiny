(function () {
  ...
  // Student range: 1 – 99,999  (enforced in index_student.html via max attribute)
  // Educator/exam range: 100,000 and above (never entered by students)
  const STUDENT_SEED_MAX = 99999;
  ...
  function generate(randomScenario = false) {
    ...
    const isBlocked = enteredSeed != null && enteredSeed > STUDENT_SEED_MAX;
